...
The `type` of storm is present in the data, and four types are given: extratropical, hurricane, tropical depression, and tropical storm. There are [complicated and not terribly precise)[https://en.wikipedia.org/wiki/Tropical_cyclone#Classifications.2C_terminology.2C_and_naming] for storm type. Build a classifier for the `type` of each storm as a function of its `wind` speed and `pressure`.  
